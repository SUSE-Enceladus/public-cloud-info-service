...
def trim_images_payload(images):
    ...
    if (accept_encoding is None or not 'gzip' in accept_encoding) and (payload_size > max_payload_size):
...
def make_response(content_dict, collection_name, element_name):
    ...
    if accept_encoding and 'gzip' in accept_encoding:
        ...
        app_type, payload = make_compressed_response(payload, collection_name, element_name, compression_type)
...
def make_compressed_response(payload, collection_name, element_name, compression_type):
